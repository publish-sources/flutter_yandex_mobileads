...
internal class LoadAppOpenAdCommandHandler(
    private val loaderHolder: AppOpenAdLoaderHolder
) : CommandHandler {
    ...
    override fun handleCommand(command: String, args: Any?, result: Result) {
        ...
        val loader = loaderHolder.loader ?: return result.error(CommandError.AppOpenAdIsNull)
